...
- 2026-07-21: **Payment Ageing dedupe** — extend `normalize_company_name` + `collapse_near_duplicate_keys` (no subset merge: Orissa ≠ Orissa Raipur); newest invoice amount; live report from invoices+receive. Optional SQL: `database/PAYMENT_AGEING_CANONICALIZE_COMPANY_NAMES.sql`. Keep Kodarma Chemical ≠ Petrochemicals.
