...
- 2026-07-20: **Post-login always default landing** — after login/OTP go to `getDefaultLandingRoute` (dashboard when permitted); do not restore prior page via `?redirect=`. `buildLoginUrl` → plain `/login` only.
